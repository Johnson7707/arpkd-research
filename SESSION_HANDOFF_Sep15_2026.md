...
| 7 | 22 | `10.1152/ajpgi.00109.2025` | ✅ **VERIFIED CORRECT** | Ciobanu C, **Outeda P**, Guggino WB, **Cebotaru L**. "A novel gene therapy for ARPKD based on CFTR." *Am J Physiol Gastrointest Liver Physiol* 329(3):G434-G442, 2025. PMID: 40763044. Content matches: AAV1-Δ27-264-CFTR IP-injected into 1-mo Pkhd1del3-4/del3-4 mice at 2×10¹² particles/kg; liver cyst area and size lower vs GFP vector; abundant GFP in cholangiocytes of cysts |
...
| 9 | 21 | `10.1152/ajpcell.00057.2025` | 🔴 **CITATION COLLISION — same DOI used for TWO different papers** | The DOI is **Ciobanu C, Cebotaru L. "AAV1-CFTR preferentially transduces cysts and reduces cyst size in a mouse model of ADPKD." *Am J Physiol Cell Physiol* 328:C1783-C1792, 2025** — correct where used in the CFTR/gene-therapy context. **BUT it was ALSO attached 3× to a PIEZO1 fibrosis claim attributed to "Konstantinou C et al."** — an entirely different paper. ⚠️ **This is a ⛔ CONTRAINDICATION: PIEZO1 was removed from therapeutic candidates partly on this citation.** ✅ FIXED — the PIEZO1 claim now rests on **Konstantinou C et al. *Nat Commun* 2024, DOI: 10.1038/s41467-024-49985-9** alone. **⚠️ ACTION: verify that Nat Commun 2024 citation before relying on the PIEZO1 contraindication.** |
...
**Running score: 11 checked · 7 wrong · 4 correct · 130+ citations corrected · 1 contraindication withdrawn · 1 contraindication confirmed and strengthened.**

### ⛔ CONTRAINDICATION AUDIT — Sep 16, 2026 (2 of 8 checked)

| Contraindication | Cited as | Verdict |
|---|---|---|
| **PIEZO1 / Yoda1** | Konstantinou AJP Cell 2025 + Nat Commun 2024 | 🔴 **BOTH FAILED → WITHDRAWN.** See below |
| **mTOR inhibitors (sirolimus)** | Masyuk AI, *Hepatology* 75(5):1110, 2022, DOI 10.1002/hep.32298 | 🔴 **WRONG PAPER — but the contraindication is CONFIRMED and STRONGER than we stated.** That DOI is the Masyuk/LaRusso autophagy paper. Correct source: **Renken C, Fischer DC, Kundt G, Gretz N, Haffner D. "Inhibition of mTOR with sirolimus does not attenuate progression of liver and kidney disease in PCK rats." PMID: 20615907.** Verified: male PCK rats on sirolimus had significantly ↑bile acids and ↑bilirubin at 12 wk (each P<0.05); neither fibrosis nor cyst area improved; **5 of 43 sirolimus-treated PCK rats DIED vs 0 controls** — a mortality signal our entry never mentioned. ✅ FIXED |
| ICG-001 | Spirli/Kaffe hep.29652 | ⬜ pending — note it inherited the repointed retracted-Spirli citation; must confirm Kaffe 2018 actually supports the ICG-001 claim |
| MCC950 · cilofexor · PDE4 · OCA · systemic dasatinib | — | ⬜ pending |

**Lesson from these two:** a wrong citation does NOT mean a wrong conclusion. PIEZO1's exclusion collapsed; mTOR's exclusion got stronger. **Each must be checked on its own evidence — do not assume either direction.**

---

### 🔴🔴 PIEZO1 CONTRAINDICATION WITHDRAWN — Sep 16, 2026
**Checked `10.1038/s41467-024-49985-9` (Konstantinou, Nat Commun 2024). IT DOES NOT RESOLVE.** Combined with the companion citation already shown to be Ciobanu/Cebotaru's AAV1-CFTR paper, **BOTH sources for the PIEZO1 contraindication failed verification.**
Real PIEZO1→CAPN2→fibrosis work exists — **Zhang L, Gui X et al. Nat Commun 17:2655, 2026, DOI 10.1038/s41467-026-70193-w** — but it is **PULMONARY fibrosis in endothelial cells**, not hepatic/biliary as our entry claimed.
**ACTION TAKEN:** PIEZO1 reclassified ⛔ CONTRAINDICATED → ⚠️ **UNRESOLVED**. Full explanation added to index.html; session-start safety list updated.
**We are NOT saying PIEZO1 is safe — we are saying we cannot support the exclusion.** Yoda1 showed 68% cyst reduction in ADPKD kidney (Fan Q, Kidney360 5:715-727, 2024 — **also pending verification**) without liver endpoints. The real open questions stand: does PIEZO1 drive fibrosis in *hepatic/biliary* tissue, and does Yoda1 raise global cytosolic Ca²⁺ rather than restoring the ciliary microdomain?
**PROVENANCE:** entry #69, Aug 21, 2026, originated from AI-assisted synthesis logged with NO primary citations; citations were added later and both are wrong. **This is the concrete harm the source rule prevents — it removed a candidate therapy.**
**🔴 QUEUE ALL REMAINING ⛔ CONTRAINDICATIONS FOR THE SAME VERIFICATION.** Known list in session-start: mTOR inhibitors, MCC950, cilofexor, PDE4, ICG-001, OCA, dasatinib systemic.
